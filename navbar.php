            ...
            <ul class="navbar-nav">
                <?php if (isset($_SESSION['logged_in'])): ?>
                    <?php if ($_SESSION['role'] === 'Admin'): ?>
                        <li class="nav-item">
                            <a class="nav-link px-4 py-3 mx-1 rounded-3 no-underline <?php echo strpos($current_page, 'admin_') === 0 ? 'active bg-primary text-white' : ''; ?>" href="admin_dashboard.php">
...
.nav-link.active:not(.no-underline)::after {
    content: '';
    display: block;
    margin: 0 auto;
    width: 60%;
...
/* Login/Register button consistency */
